                        ...
                        if (z().join("") !== d) {
                            ...
                            if (!1 === function(b, c, d) {
                                    if ("." === c.charAt(d.begin - 1) && "" !== j.radixPoint && (c = c.split(""), c[d.begin - 1] = j.radixPoint.charAt(0), c = c.join("")), c.charAt(d.begin - 1) === j.radixPoint && c.length > z().length) {
                                        ...
                                        return e.which = j.radixPoint.charCodeAt(0), da.keypressEvent.call(b, e, !0, !0, !1, d.begin - 1), !1
                                    }
                                }(c, d, f)) return !1;
                            if (d = d.replace(new RegExp("(" + e.escapeRegex(y().join("")) + ")*"), ""), !1 === function(b, c, d) {
                                    if (l) {
                                        var e = c.replace(z().join(""), "");
                                        if (1 === e.length) {
                                            var f = new a.Event("keypress");
                                            return f.which = e.charCodeAt(0),
                                                da.keypressEvent.call(b, f, !0, !0, !1, p().validPositions[d.begin - 1] ? d.begin : d.begin - 1), !1
                                        }
                                    }
                                }(c, d, f)) return !1;
                            f.begin > d.length && (M(c, d.length), f = M(c));
                            var g = z().join(""),
                            ...
                            if (i === m || h === k) {
                                if (o = {
                                        begin: h.length
                                    }, h[h.length - 1] !== k[k.length - 1] && (o.begin--, q++), i.length > m.length) o.end = o.begin;
                                else {
                            ...
                            if (o.begin < o.end) I(c, z(), o), h.split("")[h.length - 1] !== k.split("")[k.length - 1] ? (b.which = h.charCodeAt(h.length - 1), aa = !1, da.keypressEvent.call(c, b)) : (o.begin === o.end - 1 && M(c, G(o.begin + 1), o.end), b.keyCode = e.keyCode.DELETE, da.keydownEvent.call(c, b));
                            else {
                                if (-1 === r()) {
                                    for (var t = y().join(""); null === d.match(e.escapeRegex(t) + "$");) t = t.slice(1);
                                    d = d.replace(t, "")
                                }
                                a.isFunction(j.onBeforeMask) && (d = j.onBeforeMask.call(X, d, j) || d), K(c, !0, !1, d.split(""), b),
                                    function(a, b, c) {
                                        var d = M(a).begin,
                                            f = a.inputmask._valueGet(),
                                            g = f.indexOf(b),
                                            h = d;
                                        if (0 === g && d !== b.length) d = b.length;
                                        else {
                                            for (; null === f.match(e.escapeRegex(c) + "$");) c = c.substr(1);
                                            var i = f.indexOf(c); - 1 !== i && "" !== c && d > i && i > g && (d = i)
                                        }
                                        E(d) || (d = F(d)), h !== d && (M(a, d), n && setTimeout(function() {
                                            M(a, d)
                                        }, 0))
                                    }(c, h, i), !0 === P(z()) && a(c).trigger("complete")
                            }
                            b.preventDefault()
                        }
                    },
        ...
        return e.prototype = {
            ...
            mask: function(g) {
                ...
                return "string" == typeof g && (g = c.getElementById(g) || c.querySelectorAll(g)), g = g.nodeName ? [g] : g, a.each(g, function(b, c) {
                    ...
                    g !== d && (c.inputmask !== d && c.inputmask.remove(), c.inputmask = new e(d, d, !0), c.inputmask.opts = f, c.inputmask.noMasksCache = k.noMasksCache, c.inputmask.userOptions = a.extend(!0, {}, k.userOptions), c.inputmask.isRTL = f.isRTL || f.numericInput, c.inputmask.el = c, c.inputmask.maskset = g, a.data(c, "_inputmask_opts", f), i.call(c.inputmask, {
                        action: "mask"
                    }))
            ...
            analyseMask: function(b, c, f) {
                ...
                function h(b, g, h) {
                    ...
                    var i = b.matches[h - 1];
                    if (c) 0 === g.indexOf("[") || u || "." === g ? b.matches.splice(h++, 0, {
                ...
                for (c && (f.optionalmarker.start = d, f.optionalmarker.end = d); l = c ? t.exec(b) : s.exec(b);) {
                    if (m = l[0], c && !0 !== u) switch (m.charAt(0)) {
                        case "?":
                            m = "{0,1}";
                            break;
                        case "+":
